...
import_electron.contextBridge.exposeInMainWorld("lexentia", {
  workspace: {
    ...
    newFile: () => import_electron.ipcRenderer.invoke("workspace:newFile"),
    pickFile: () => import_electron.ipcRenderer.invoke("workspace:pickFile")
  },
  fs: {
  ...
  skills: {
    ...
    read: (name) => import_electron.ipcRenderer.invoke("skills:read", name)
  },
  terminal: {
